...
public class Program
{
    public static void Main()
    {
        ...
        var ast = TypedAstGenerator.Generate(dyn.expression);

        Interpreter.Handle(ast, new InterpretationEnvironment() { Objects = new Dictionary<string, InterpretationResult>() });
    }
}
